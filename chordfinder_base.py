...
# Imports MongoClient with Pymongo, and Certifi
from pymongo import MongoClient
import certifi

# Asks the User the notes of the tune section they want chords for and places that input into a list
tune_notes = []
enter_notes = input("Enter Notes of the Tune Section (Hook, Verse, Bridge) (MAKES SURE TUNE ENDS WITH ROOT NOTE) (Ex. A,A#,A-flat): ")
...
# Lets the Program know if the Tune Scale is Major or Minor
is_major = False
is_minor = False
...
while try_new_chord == "Y":
    ...
    chord_type = input("Which type of Chords would you like (CASE SENSITIVE: Triad, Bright Triad, Augmented, Diminished, Dominant 7th)?: ")
    ...
    while chord_type == "Augmented" and is_minor == True:
        chord_type = input("NOT VALID - AUGMENTED CHORDS CAN ONLY WORK WITH MAJOR SCALES: Choose a different type of chord (CASE SENSITIVE: Triad, Bright Triad, Augmented, Diminished, Dominant 7th)?: ")
    while chord_type == "Diminished" and is_major == True:
        chord_type = input("NOT VALID - DIMINISHED CHORDS CAN ONLY WORK WITH MINOR SCALES: Choose a different type of chord (CASE SENSITIVE: Triad, Bright Triad, Augmented, Diminished, Dominant 7th)?: ")
    while chord_type =="Dominant 7th" and is_minor == True:
        chord_type = input("NOT VALID - DOMINANT 7TH CHORDS CAN ONLY WORK WITH MAJOR SCALES: Choose a different type of chord (CASE SENSITIVE: Triad, Bright Triad, Augmented, Diminished, Dominant 7th)?: ")
