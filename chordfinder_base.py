...
# A Program that results a set of chords, it's notes, and the order to play them according to the tune the user inputs from a section of a song
...
while try_new_chord == "Y":
    ...
    while chord_type == "augmented" and is_minor == True:
        chord_type = input("NOT VALID: Which type of Chords would you like (Triad: triad, Bright Triad: bright_triad, Augmented: augmented, Diminished: diminished, Dominant 7th: dominant7)?: ")
    while chord_type == "diminished" and is_major == True:
        chord_type = input("NOT VALID: Which type of Chords would you like (Triad: triad, Bright Triad: bright_triad, Augmented: augmented, Diminished: diminished, Dominant 7th: dominant7)?: ")
    while chord_type =="dominant7" and is_minor == True:
        chord_type = input("NOT VALID: Which type of Chords would you like (Triad: triad, Bright Triad: bright_triad, Augmented: augmented, Diminished: diminished, Dominant 7th: dominant7)?: ")
